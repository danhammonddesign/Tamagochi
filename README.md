...
Everything else is the same. They eat the same seven things, drink the same
three, play the same games and grow up the same way.
...
own collection from scratch. **A tank pet has a different set of eleven** to suit
a tank — see below.
